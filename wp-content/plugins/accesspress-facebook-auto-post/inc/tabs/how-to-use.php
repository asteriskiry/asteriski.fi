<div class="asap-section" id="asap-section-how" <?php if ($active_tab != 'how') { ?>style="display: none;"<?php } ?>>
    <div class="more-title"><?php _e('Facebook Graph API Auto Post ( Deprecated )', 'accesspress-facebook-auto-post'); ?></div>
    <p><?php _e('For Facebook Auto Post, you will need to get ', 'accesspress-facebook-auto-post'); ?>
   ...
   <div class="clearfix" style="margin-top:12px;"></div>
    <div class="more-title"><?php _e('Facebook Mobile API Auto Post ( Major Updates )', 'accesspress-facebook-auto-post'); ?></div>
